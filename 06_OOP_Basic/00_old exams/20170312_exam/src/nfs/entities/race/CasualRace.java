...
public class CasualRace extends Race {
	...
	public String getWinners() {
		...
		LinkedHashMap<Integer, Car> orderedParticipants = super.getParticipants()
                .entrySet()
                .stream()
		...
		for (Map.Entry<Integer, Car> entry : orderedParticipants.entrySet()) {
			...
			sb.append(count).append(". ").append(entry.getValue().getBrand()).append(" ").append(entry.getValue().getModel()).append(" ")
			.append(entry.getValue().getOverallPerformance()).append("PP - $").append(super.countPrize(count)).append("\r\n");
